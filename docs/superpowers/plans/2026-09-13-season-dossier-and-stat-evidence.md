...
- [x] **Step 1: Write a schema contract test**
...
- [x] **Step 2: Run the test and typecheck to verify failure**
...
- [x] **Step 4: Add the exact DTO families**
...
- [x] **Step 5: Generate Prisma and verify**
...
- [x] **Step 3: Implement focused pure functions**
...
- [x] **Step 3: Implement the assembler**
...
- [x] **Step 4: Add Mobile API route and contract test**
...
- [x] **Step 1: Write validation and authorization tests**
...
- [x] **Step 1: Write the failing editor behavior test**
...
- [x] **Step 3: Implement the protected Server Component**
...
- [x] **Step 4: Implement the client editor**
...
- [x] **Step 5: Add admin navigation and verify**
...
- [x] **Step 4: Implement accessible evidence disclosures**
...
- [x] **Step 1: Write failing hook and screen tests**
...
- [x] **Step 3: Implement hook and navigation**
...
- [x] **Step 4: Implement native screen**
...
- [x] **Step 1: Write opt-in isolated-DB integration test**
...
- [x] **Step 2: Run schema and integration test against disposable PostgreSQL**
...
- [x] **Step 4: Version and deployment notes**
...
Review the final diff for security, public draft leakage, duplicated metric logic and mobile/web contract drift. Commit with `feat(seasons): launch dossier pilot`, push `codex/season-dossier-pilot`, and report checks plus any residual limitations.
